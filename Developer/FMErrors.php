...
$errorsList = array(
  ...
  "302" => "FM5-6: Script definitions are in use by another user; FM7: Table is in use by another user",
  "303" => "FM5-6: Paper size is in use by another user; FM7: Database schema is in use by another user",
  "304" => "FM5-6: Password definitions are in use by another user; FM7: Layout is in use by another user",
  ...
  "717" => "There is not enough XML/XSL information to proceed with the current import or export",
  ...
  "721" => "Unknown error occured in the parser or the transformer",
  "722" => "Cannot imnport data into a file that has no fields",
  "723" => "You do not have permission to add records or to modify records in the target table",
  ...
  "730" => "Unsupported Excel version. (Convert file to Excel 7.0 (Excel 95), Excel 97, 2000, or XP format an try again)",
  ...
  "824" => "File is damaged or is not a FileMaker file",
  ...
  "904" => "Command can only be used in a file hosted under FileMakerÊServer",
  ...
  "1204" => "Number, text constant, field name or Ò(Ò expected",
  "1205" => "Comment is not terminated with \"*/\"",
  "1206" => "Text constant must end with a quotation mark",
  "1207" => "Unbalanced parenthesis",
  "1208" => "Operator missing, function not found or Ò(Ò not expected",
